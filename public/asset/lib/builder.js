...
/**
 *@author Rubinmon <rubinmon@colanonline.com>
 **/
function Builder(){
...
/**Image base path*/
Builder.IMAGE_BASE_PATH = 'asset/assets/images/';
...
Builder.constructCanvasPropertiesPanel = function(DOMObject, canvasProps){
    ...
    btnUpdate.setAttribute("id", "updateT");
...
BuilderProperty.TYPE_COLOR_CODE = 'Bgcolor';
/**Text property type*/
...
/**Line width property type*/
BuilderProperty.TYPE_SHAPE_WIDTH = 'ShapeWidth';

/**Line width property style*/
BuilderProperty.TYPE_LINE_STYLE = 'LineStyle';

/**image height */
BuilderProperty.TYPE_FIGURE_HEIGHT = 'Height';
...
/**SHAPE WIDTH sizes*/
BuilderProperty.SHAPE_WIDTHS = [];
for(var i=1; i<=1000; i++){
  BuilderProperty.SHAPE_WIDTHS.push({Text:i+'px', Value:i});
}
...
BuilderProperty.prototype = {
    ...
    injectInputArea:function(DOMObject, figureId){
        ...
        else if(this.type === BuilderProperty.TYPE_COLOR_CODE){
            this.generateColorCode(DOMObject, figureId);
        }
        ...
        else if(this.type === BuilderProperty.TYPE_SHAPE_WIDTH){
            this.generateArrayCode(DOMObject,figureId, BuilderProperty.SHAPE_WIDTHS);
        }
        else if(this.type === BuilderProperty.TYPE_LINE_STYLE){
            this.generateArrayCode(DOMObject,figureId, BuilderProperty.LINE_STYLES);
        }
        else if(this.type === BuilderProperty.TYPE_FIGURE_HEIGHT){
            this.generateArrayCode(DOMObject,figureId,BuilderProperty.IMAGE_HEIGHT);
        }
...
//        Log.info("Font size length: " + v.length);
        ...
        //select.setAttribute('onclick','Heightchange(this)');
...
//            Log.info("\t Text : " + v[i].Text + " Value : " + v[i].Value);
          // console.log("\t Text : " + v[i].Text + " Value : " + v[i].Value);
