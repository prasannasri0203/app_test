...
figureSets["basic"] = {
    ...
    figures: [
        ...
        //{figureFunction: "Parallelogram", image: "rub.png"}
    ]
};
...
function figure_Rectangle(x, y,mode,hejwensdnfs)
{
    x=10;
    y=23;
    ...
    f.properties.push(new BuilderProperty('Bg Color', 'primitives.1.style.bgStyle', BuilderProperty.TYPE_COLOR_CODE));
    ...
    f.properties.push(new BuilderProperty('Figure Height', 'style.figuHeight',BuilderProperty.TYPE_FIGURE_HEIGHT));

    f.properties.push(new BuilderProperty('Shape Width', 'style.width',BuilderProperty.TYPE_SHAPE_WIDTH));
