                            ...
                            <div class="d-flex align-items-center algorithem_part before_hover">
                                ...
                                <div class="algorithem_text">
                                    ...
                                    <?php  $open_date ='';   
                                        ...
                                        {
                                          if(Auth::user()->id == optional($userthemp->userTemplateTrack)->user_id){
                                ...
                                <div class="card-body p-0">
                                    <div class="d-flex align-items-center algorithem_part before_hover">
                                        ...
                                        <div class="algorithem_text">
                                            ...
                                            {
                                              if(Auth::user()->id == optional($mapTemplate->userTemplateTrack)->user_id){
                                    ...
                                    <div class="d-flex align-items-center algorithem_part after_hover">
                                        <div class="d-flex align-items-center after_algorithem">
                                            <a href="{{url('/flowchart?user='.$mapping->mapped_flowchart_id)}}"><button class="btn" type="button">Open</button></a>
                                            @if($fcstatus2 == 1)
                                                <div class="share_part" onclick="shareChart({{ $mapping->mapped_flowchart_id }})" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                                    <img src="{{asset('images/front_images/user_module/share.png')}}">
                                                    <p class="mb-0">Share</p>
                                                </div>
                                            @endif    
