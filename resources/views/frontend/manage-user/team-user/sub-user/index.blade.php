...
<div class="container-fluid px-4 main_part">
    <div class="t-h">
        <a href="{{url('/sub-user-list')}}">
            <h4 class="Acc_Setting bl">Manage User List </h4>
        </a>
         <a href="{{route('add-sub-user')}}" class="float-right" >
 ...
 <form action="{{url('/sub-user-list')}}" autocomplete="off" method="get" >
                    <input type="hidden" name="base_url" value="{{url('/')}}"> 
                     
                 <div class="filter_by_sec more-list-filter list-filter-div">
                    ...
                    <div class="distict_btn  list-filter">
                        ...
                        <a href="{{url('/sub-user-list')}}"><button type="button" class="btn blue_btn" style="background-color:green">Reset</button></a>
                     </div>
                </div>
         </form>
                ...
                <table class="distict_table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td> {{ucFirst($list->team($list->parent_id))}} </td>
                            <td> {{$list->email}} </td>
                            ...
                            <td> 
                             ...
                             <div class="table_last">         
                                ...
                                <span><a href="{{url('/create/sub-user/'.$list->id)}}"><img src="images/Edit.png" title="Edit"></a></span>
                                <span> 
                                  <a onclick="return confirm('Are you sure to delete?')" href="{{route('sub-users-delete',[$list->id])}}"><img src="images/Delete.png"></a>  
                                </span>
                  ...
                  <tr>
                     <td colspan="3"></td>
                     <td colspan="3" class="text_cen">No Users Available</td>
                     <td colspan="3"></td>                    
                  </tr>
                  @endif
                    </tbody>
