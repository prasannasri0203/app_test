...
<script>
    ...
    function myFuncdef(id) {
        var ele = document.getElementById("exampleModalCenterdefault");
        ele.classList.toggle("myFuncdef").addclss.hide();
    }
    function myClose(id) {
