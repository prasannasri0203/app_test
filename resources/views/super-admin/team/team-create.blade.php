...
<div class="header_left">
  <h1>{{ (!empty($user->id)) ? 'Edit Team User' : 'Add Team User'}}</h1>
</div>
<form method="POST" action="{{ route('store-team-user',[!empty($user->id) ? $user->id : null ]) }}" enctype="multipart/form-data">
  @csrf
  <div class="inner-wrapper-g">
    <div class="filter-sec d-flex align-items-center w-bg flex-wrap">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-12 col-sm-12 col-xs-12">
            <div class="pr-la-in">
              ...
              @if(!empty($user->id))
              <input type="text" placeholder="Enter Email" name="email" readonly="readonly" value="{{$user ? $user->email : old('email') }}">
              @else
          ...
          <div class="col-lg-3 col-md-12 col-sm-12 col-xs-12">
            <div class="pr-la-in">
              ...
              <input type="text" maxlength="12" placeholder="Enter Number"  data-mask="999-999-9999" name="contact_no"
          ...
          <div class="col-lg-3 col-md-12 col-sm-12 col-xs-12">
            <div class="pr-la-in">
              ...
              <input type="password" placeholder="Enter Confirm Password" value="{{old('password_confirmation') }}" name="password_confirmation">
      ...
      <div class="button_section">
        ...
        <a href="{{route('team-users')}}"><button type="button" class="btn white_btn">Cancel</button></a>
      </div>    
    </div> 
