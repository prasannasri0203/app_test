            ...
            <div class="main_content">
                ...
                <div class="main_head">
                   <div class="menue_first_head">
                        <div class="list_head">
                            <h1>Manage Individual Users </h1>
                        </div>
                        <div class="distict_btn">
                            <a href="{{URL('/create-individualuer')}}"><button class="btn blue_btn">Add User</button></a>
                        </div>
                    </div>
                </div>
                <form method="GET" action="{{url('/individualuser')}}" >    
                <div class="filter_by_sec">
                    ...
                    <div class="distict_btn list-filter">
                        ...
                        <a href="{{url('/individualuser')}}"><button type="button" class="btn blue_btn" style="background-color:green">Reset</button></a>
                     </div>
                </div>
                ...
                <div class="table_main_dist table-responsive">
                    <table class="distict_table">
                        ...
                        <tbody>
                                    ...
                                    <td>{{ucfirst($user['userDetail']['organization_name'])}}</td>
                                     ...
                                     <td>
                                        <div class="table_last">    
                                            ...
                                            <span><a href="{{url('/create-individualuer/'.$user->id)}}"><img src="images/Edit.png" title="Edit"></a></span>
                                            <span><a onclick="return confirm('Are you sure to delete?')" href="{{url('/deleteinduser/'.$user->id)}}"><img src="images/Delete.png"></a></span>
                                        </div>
                                    </td>
                                </tr>
                                @endforeach
                            @else
                                <tr> 
                                    <td  class="text_cen" colspan="8">No Individual Users Available</td>
                                </tr>
                            @endif
  ...
  <div class="modal-dialog modal-xl" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalCenterTitle">Individual User Detail </h5>
              ...
              <tr class="viewmodel_tr">
                ...
                <td>@if($user->status==1) Active @else Inactive @endif</td>
                    ...
                    <th>Adderss</th>
                     ...
                     {{ucfirst($user['userDetail']['address'])}},{{ucfirst($user['userDetail']['city'])}},{{ucfirst($user['userDetail']['province'])}}-{{ucfirst($user['userDetail']['postal_code'])}}
                     @else
                      -
                      @endif
                   </td>
...
<div class="table-footer"> 
 <div class="col-xs-12 text-right" align="left">
    {{ $users->appends(['email'=>$email,'user_name'=>$user_name,'mobile'=>$mobile,'status'=>$status,Request::except('page')])->links('vendor.pagination.default')}}
</div>
</div>
    </div>
@endsection 