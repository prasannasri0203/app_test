            ...
            <div class="main_content">
                ...
                <div class="main_head">
                   <div class="menue_first_head">
                        ...
                        <div class="distict_btn">
                            <a href="{{route('add-trial-user')}}"><button class="btn blue_btn">Add Trial User</button></a>
                        </div>
                    </div>
                </div>
                <form method="GET" action="{{ route('trial-users') }}" >    
                <div class="filter_by_sec">
                    ...
                    <div class="distict_btn list-filter">
                        ...
                        <a href="{{url('/trial-users')}}"><button type="button" class="btn blue_btn" style="background-color:green">Reset</button></a>
                     </div>
                </div>
                ...
                <div class="table_main_dist table-responsive">
                    <table class="distict_table">
                        ...
                        <tbody>
                                    ...
                                    <td>{{ucfirst($user['userDetail']['organization_name'])}}</td> 
                                     ...
                                     <td>
                                        <div class="table_last">
                                            ...
                                            <span><a href="{{url('/create/trial/'.$user->id)}}"><img src="images/Edit.png" title="Edit"></a></span>
                                            <span><a onclick="return confirm('Are you sure to delete?')" href="{{route('trial-users-delete',[$user->id])}}"><img src="images/Delete.png"></a></span>                                              
                                        </div>
                                    </td>
                                </tr>
                                @endforeach
                            @else
                                <tr> 
                                    <td class="text_cen" colspan="8">No Trail Users Available</td>
                                </tr>
                            @endif
  ...
  <div class="modal-dialog modal-xl" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalCenterTitle">Trail User Detail </h5>
