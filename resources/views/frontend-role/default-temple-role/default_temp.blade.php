                    ...
                    <select class="form-pik-er" name="template_cat_id">
                        <option value="">Select Category</option>  
                          @foreach($template_category as $cat) 
                           <option value="{{$cat->id}}"  @if($template_cat_id==$cat->id) selected @endif>{{$cat->name}}</option>
                          @endforeach 
                    </select>
...
<div id="usetemplate-model" class="modal fade">
  <div class="modal-dialog modal-confirm">
    <div class="modal-content">  
      <form method="POST" action="{{route('use_template_role_update')}}">
                      @csrf
        ...
        <div class="lbl_text"> 
          ...
          <div class="form-group">
            ...
            <input type="hidden" name="tempid" id="tempid" value="" /> 
             ...
             <input type="hidden" name="parentid" id="parentid" value="{{Auth()->guard('roleuser')->user()->parent_id}}" />              
