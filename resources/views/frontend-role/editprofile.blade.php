...
@section('content')
    <div class="container-fluid px-md-4 px-2 main_part">
        <div class="t-h">
          ...
          <form method="POST" action="{{url('/role-user/edituser-submit')}}"  enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                <div class="pr-la-in as-i">
                                    ...
                                    <!-- <span style="font-size: 11px; color: #55565a; ">The image should be in "166px*55px" dimension.</span> -->
 ...
 -->
            ...
            <div class="button_section">
                ...
                <a href="{{url('/role-user/account-setting')}}"><button type="button" class="btn white_btn">Cancel</button></a>
            </div>
        </form>
    </div>
@endsection